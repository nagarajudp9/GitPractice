...
web_reg_save_param_ex("ParamName=cp_orderId","LB=<input type=\"hidden\" name=\"orderId\" id=\"orderId\" value=\"","RB=\"/>",LAST);
	...
	web_reg_save_param_ex("ParamName=cp_orderNo","LB=<input type=\"hidden\" name=\"ormOrderId\" id=\"ormOrderId\" value=\"","RB=\"/>","NotFound=Warning",LAST);
	...
	web_reg_save_param("cp_orderItemId","LB=id=\"cItem","RB=\">","Ordinal=ALL",LAST);	
	
	lr_start_transaction("CP24_ViewCart_CTO");
	
	//lr_start_sub_transaction("CP24-1_ViewCart_CTO","CP24_ViewCart_CTO");
	
	web_url("OrderCalculate",
			"URL=https://{p_hostName}/us-en/shop/OrderCalculate?calculationUsageId=-1&catalogId=10051&updatePrices=1&langId=-1&storeId=10151&URL=AjaxOrderItemDisplayView&configCatentryId={cp_CatEntryID}",
			"Resource=0", 
...
//lr_end_sub_transaction("CP24-1_ViewCart_CTO",LR_AUTO);
