...
{	
	...
	/*web_url("PunchoutOrdersView", 
		"URL=https://perf.store.hp.com/us-en/shop/PunchoutOrdersView?storeId=10151&catalogId=10051", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://perf.store.hp.com/us-en/shop/SMBPrivateAccountManagementView?catalogId=10051&langId=-1&storeId=10151", 
		"Snapshot=t10.inf", 
		"Mode=HTML", 
		LAST);

	web_url("HPServices_3", 
		"URL=https://perf.store.hp.com/us-en/shop/HPServices?langId=-1&storeId=10151&catalogId=10051&pstoreId=&_=1628515038140&action=cupids&catentryId=&modelId=", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://perf.store.hp.com/us-en/shop/PunchoutOrdersView?storeId=10151&catalogId=10051", 
		"Snapshot=t11.inf", 
		"Mode=HTML", 
		LAST);*/
...
//	web_reg_save_param("cp_MemberId","LB=\"memberId\": \"","RB=\",","ORD=ALL","NotFound=Warning",LAST);
	...
	if(atoi(lr_eval_string("{OsNoCount}")) > 0)
		...
		{
			lr_end_transaction("CP40_OS_ByNo",LR_AUTO);
