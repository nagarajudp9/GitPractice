CC_byPhone()
{
	...
	web_reg_save_param("cp_custPhone","LB=\"UserID\":\"","RB=\"","ORD=ALL","Notfound=warning",LAST);
	
	web_set_sockets_option("CLOSE_KEEPALIVE_CONNECTIONS","1");
	
	lr_start_transaction("C03_CS_ByPhone");

	web_custom_request("isccs.customer.search.CustomerListScreenBehaviorController.do_4", 
		...
		"%7B%22isccs_customer_search_CustomerListScreenBehaviorController%22%3A%7B%22controllerId%22%3A%22isccs_customer_search_CustomerListScreenBehaviorController%22%2C%22MashupRefs%22%3A%7B%22MashupRef%22%3A%5B%7B%22mashupRefId%22%3A%22getCustomerList%22%2C%22Input%22%3A%7B%22Customer%22%3A%7B%22ApplyQueryTimeout%22%3A%22Y%22%2C%22CallingOrganizationCode%22%3A%22USWS%22%2C%22CustomerType%22%3A%2202%22%2C%22HPCustomerSearch%22%3A%7B%22HPSearchKey%22%3A%22{p_CustomerSearchByPhone}%22%2C%22HPSearchType%22%3A%22phone%22%2"
		"C%22HPSearchCond%22%3A%22Exact%20Match%22%7D%7D%7D%7D%5D%7D%7D%7D&scCSRFToken={scCSRFToken}&scFlag=Y", 
		LAST);
	

lr_end_transaction("C03_CS_ByPhone",LR_AUTO);	

custPhonecount=atoi(lr_eval_string("{cp_custPhone_count}"));
...
pmax=atoi(lr_eval_string("{cp_custPhone_count}"));
					
prand= (rand() % pmax)+1;
			
//sprintf(spara,"{cp_custPhone_%d}",prand);
...
lr_start_transaction("C04_CustomerSelection");
	...
	web_custom_request("wizardController.do_3", 
		...
		"%7B%22scWizardDefId%22%3A%22isccs.customer.wizards.customerDetails.CustomerDetailsWizard%22%2C%22isWizard%22%3Atrue%2C%22scControllerInput%22%3A%7B%22Customer%22%3A%7B%22CustomerContactList%22%3A%7B%22CustomerContact%22%3A%5B%7B%22LastName%22%3A%22Smith%22%2C%22UserID%22%3A%22{cp_UserId}%22%2C%22EmailID%22%3A%22{cp_UserId}%22%2C%22FullName%22%3A%22Rick%2C%20Smith%22%2C%22Name%22%3A%22Rick%20Smith%22%2C%22FirstName%22%3A%22Rick%22%2C%22CustomerAdditionalAddressList%22%3A%7B%22Cu"
		"stomerAdditionalAddress%22%3A%5B%7B%22PersonInfo%22%3A%7B%22MiddleName%22%3A%22%22%2C%22State%22%3A%22CA%22%2C%22LastName%22%3A%22Smith%22%2C%22CombinedAddressLine%22%3A%22beverly%20hills%20california%20%22%2C%22Country%22%3A%22%22%2C%22EmailID%22%3A%22{cp_UserId}%22%2C%22FirstName%22%3A%22Rick%22%2C%22City%22%3A%22usa%22%2C%22ZipCode%22%3A%2290210%22%7D%7D%5D%7D%2C%22Phone%22%3A%22{p_CustomerSearchByPhone}%22%7D%5D%7D%2C%22CartItems%22%3A%22N%22%2C%22OrganizationCode%22%3A%22USWS%22%2C%22CustomerKey"
		"%22%3A%22{cp_CustomerKey}%22%2C%22SMBId%22%3A%22%22%2C%22HPPID%22%3A%22{cp_HPPID}%22%2C%22DBSrc%22%3A%22WCS%22%2C%22CIDNumber%22%3A%22%22%2C%22CompanyName%22%3A%22%22%2C%22SystemType%22%3A%22ETR%22%2C%22LastVisit%22%3A%22%22%2C%22CustomerType%22%3A%2202%22%2C%22PricingStatus%22%3A%22GS%22%2C%22CustomerID%22%3A%22WCS%22%2C%22SMBProfileType%22%3A%22Consumer%22%2C%22CIC%22%3A%22%22%7D%7D%7D&scCSRFToken={scCSRFToken}&scFlag=Y", 
		LAST);
