CTO()
{
	...
	//web_reg_save_param("cp_CatEntryID","LB=\"CTO\",\"prodId\":\"","RB=\"",LAST);
	...
	lr_start_transaction("CP08_PDP_CTO");
...
web_reg_find("Text=\"lowStock\": true", "SaveCount=c_OutOfStock", LAST);
    ...
    {
	lr_end_transaction("CP08_PDP_CTO",LR_PASS);
    }
    else
    {
	lr_end_transaction("CP08_PDP_CTO",LR_FAIL);
