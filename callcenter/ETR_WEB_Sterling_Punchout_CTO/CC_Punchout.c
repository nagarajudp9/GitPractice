...
//		LAST);
	...
	web_url("browseEstore", 
		...
		"Referer=https://glbecom-perf-oms.inc.hpicorp.net/", 
		"Snapshot=t1.inf", 
		"Mode=HTML", 
		LAST);
...
//		LAST);
	...
	web_submit_data("cclogon", 
		...
		"Method=POST", 
		"RecContentType=text/html", 
		"Referer=https://{p_hostName}/webapp/wcs/stores/servlet/browseEstore?storeId=10151&ccCustId={cp_CustomerKey}", 
		"Snapshot=t2.inf", 
		"Mode=HTML", 
		ITEMDATA, 
		"Name=URL", "Value=browseEstore", ENDITEM, 
		"Name=reLogonURL", "Value=ccStoreLogonView", ENDITEM, 
		"Name=ccCustId", "Value={cp_CustomerKey}", ENDITEM, 
		"Name=exchangeData", "Value=", ENDITEM, 
	...
	web_url("shop", 
		...
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://{p_hostName}/us-en/shop/StoreView?storeId=10151&catalogId=10051&langId=-1&krypto={cp_krypto}&ddkey=https%3Acclogon", 
		"Snapshot=t3.inf", 
		"Mode=HTML", 
		LAST);
	
web_url("HPServices", 
		"URL=https://{p_hostName}/us-en/shop/HPServices?_=1655832233118&action=cus&catentryId=&modelId=&langId=-1&storeId=10151&catalogId=10051", 
		"Resource=0", 
		"RecContentType=text/html", 
