AddToCart_CTO()
{
	...
	//lr_start_sub_transaction(lr_eval_string("CP23-1_AddToCart_CTO{cartitem}{cartLineitem}"),"S23_AddToCart_CTO");
...
web_reg_find("Search=All","Text=Just added to cart","savecount=C_cartAdded",LAST);
	...
	// lr_end_sub_transaction(lr_eval_string("CP23-1_AddToCart_CTO{cartitem}{cartLineitem}"),LR_AUTO);
