...
//web_reg_find("Search=All","SaveCount=c_PHCPoller","Text=billto_zipcode",LAST);PHCPollerCmd
//web_reg_find("Search=All","SaveCount=c_PHCPoller","Text=PHCPollerCmd",LAST);
...
//	{
	...
	lr_end_transaction("CP27_Checkout_CC_Saved",LR_PASS);
	//lr_end_transaction("CP27_Checkout_CC_Saved",LR_PASS);
//	}
//	else
//	{
...
//	}
	...
	web_custom_request("CallPHC", 
		...
		"paymentRequestVM%5BCustomerInfo%5D%5BPhone%5D=9878787674&paymentRequestVM%5BCustomerInfo%5D%5BHostName%5D=&paymentRequestVM%5BCustomerInfo%5D%5BIPAddress%5D=&paymentRequestVM%5BCustomerInfo%5D%5BHpCustomerNumber%5D=&paymentRequestVM%5BCustomerInfo%5D%5BCompanyName%5D=&paymentRequestVM%5BCustomerInfo%5D%5BIsGuestUser%5D=false&paymentRequestVM%5BReturnKey_Continue%5D="
...
//	{
//
	lr_end_transaction("CP30_Pay_CC_Review",LR_AUTO);//CP30_Pay_CC_Review
//	}
//	else
//	{
