MyQuotes()
{
	...
	{
	web_set_sockets_option("CLOSE_KEEPALIVE_CONNECTIONS","1");	
	lr_start_transaction("CP43_QS_ByNo");
	...
	web_submit_data("GetPunchoutQuotes", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=quoteNumber", "Value={p_qs_byNo}", ENDITEM, 
		"Name=endUserEmail", "Value=", ENDITEM, 
		"Name=accountName", "Value=", ENDITEM, 
	...
	if(atoi(lr_eval_string("{QsNoCount}")) > 0)
		{
			lr_end_transaction("CP43_QS_ByNo",LR_PASS);
	...
	pmaxValue = atoi(lr_eval_string("{cp_QuoteNo_count}"));	
	if(pmaxValue>0)
	{
	...
	web_set_sockets_option("CLOSE_KEEPALIVE_CONNECTIONS","1");		
		...
		//web_reg_find("Text=Quote summary","SaveCount=ViewQuoteCount",LAST);
		/*web_url("browseEstore", 
		"URL=https://perf.store.hp.com/us-en/shop/browseEstore?ccQotNo=Q343035514&ccCustId=47578821", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://perf.store.hp.com/us-en/shop/PunchoutQuotesView?storeId=10151&catalogId=10051", 
		"Snapshot=t9.inf", 
		"Mode=HTML", 
		LAST);
	...
	web_url("HPServices_3", 
		"URL=https://perf.store.hp.com/us-en/shop/HPServices?langId=-1&storeId=10151&catalogId=10051&pstoreId=&_=1628517848614&action=cupids&catentryId=&modelId=", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://perf.store.hp.com/us-en/shop/quoteDetailsView?storeId=10151&catalogId=10051&krypto=nNT%2BbxRYKuO4VGX0GI1k5FXu0DsgfX5vf0dFjJWO1QZLPNMmKaf65D%2BjdoWRqt4S%2BTuJnUHAfKOUcl01SDzxwE1luW0x0ca%2BIYC0UDYquUduK1jVNVhanCVNnqfYyyxJyXIGrw%2BseEG3Ay%2BCbBMwohTIpwEW2EeYGGXwusUpoTfWkfCVdCYgNCa3K%2B6c2q3ZG35%2BHagRVQEDbRsxUG524SWvxCSS1gPxNKT1ZlBmsuvvt6R9AzLG%2B%2FOL2lCJiSBR&ddkey=https%3AbrowseEstore", 
		"Snapshot=t12.inf", 
		"Mode=HTML", 
		LAST);*/
		...
		web_url("HPServices_4", 
			...
			"URL=https://{p_hostName}/us-en/shop/HPServices?langId=-1&storeId=10151&catalogId=10051&pstoreId=&_=1628517848614&action=cupids&catentryId=&modelId=&retainPOCart=false",
			"TargetFrame=", 
			"Resource=0", 
			"RecContentType=text/html", 
			"Referer=https://{p_hostName}/us-en/shop/quoteDetailsView?storeId=10151&catalogId=10051&krypto=nNT%2BbxRYKuO4VGX0GI1k5FXu0DsgfX5vf0dFjJWO1QZLPNMmKaf65D%2BjdoWRqt4S%2BTuJnUHAfKOUcl01SDzxwE1luW0x0ca%2BIYC0UDYquUduK1jVNVhanCVNnqfYyyxJyXIGrw%2BseEG3Ay%2BCbBMwohTIpwEW2EeYGGXwusUpoTfWkfCVdCYgNCa3K%2B6c2q3ZG35%2BHagRVQEDbRsxUG524SWvxCSS1gPxNKT1ZlBmsuvvt6R9AzLG%2B%2FOL2lCJiSBR&ddkey=https%3AbrowseEstore",
			"Snapshot=t38.inf", 
			"Mode=HTML", 
			LAST);
...
//			{
	lr_end_transaction("CP44_ViewQuote",LR_AUTO);
//			}
//			else
//			{
