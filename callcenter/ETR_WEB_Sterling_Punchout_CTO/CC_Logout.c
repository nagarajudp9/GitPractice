...
//		LAST);
	...
	web_url("browseEstore_3", 
		"URL=http://{p_hostName}/us-en/shop/browseEstore?catalogId=10051&langId=-1&storeId=10151", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
		//"Referer=http://{p_hostName}/webapp/wcs/stores/servlet/TopCategoriesDisplay?catalogId=10051&storeId=10151&krypto=MgAJar2j2aZbjugfAG531xVkRS6ocbCc7bh0tGnEIuCgAhnWN8lkJPzoFdZA3ApEZQg38aHYcFDmPanXaDkK6TvzH7t91ZHaYmRFjYN%2FQ4%2F9YssnHvadAmqFPuaio9l%2F8j%2FzbmJWtrroO0wxUPp5jc4UkmYWO3AN69R1w1bw%2BkM%3D&ddkey=https%3AbrowseEstore", 
	...
	web_url("ccEndCustomerCall", 
		"URL=http://{p_hostName}/us-en/shop/ccEndCustomerCall?catalogId=10051&langId=-1&storeId=10151", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
		//"Referer=http://{p_hostName}/webapp/wcs/stores/servlet/TopCategoriesDisplay?catalogId=10051&langId=-1&storeId=10151&krypto={cp_krypto}&ddkey=http%3AbrowseEstore", 
		"Referer=",
		"Snapshot=t71.inf",
		"Mode=HTML", 
		LAST);
	...
	web_url("logout.do", 
		"URL=https://{p_SterlingHostName}/isccs/isccs/logout.do?scCSRFToken={scCSRFToken}&scFlag=Y", 
		"Resource=0", 
		"RecContentType=text/html", 
