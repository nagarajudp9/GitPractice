Pay_Leasing()
{
	...
	web_submit_data("AjaxOrderShipInfoUpdate", 
		...
		"Name=address1", "Value=PerfTesting", ENDITEM, 
	...
	web_submit_data("OrderSubmitServiceCmd", 
		...
		"Name=shipto_companyname", "Value=PerfTest", ENDITEM, 
		"Name=shipto_address1", "Value=PerfTesting", ENDITEM, 
		...
		"Name=shippingCompanyName", "Value=PerfTest", ENDITEM, 
		"Name=shippingAddress1", "Value=PerfTesting", ENDITEM, 
		...
		"Name=billto_address1", "Value=PerfTesting", ENDITEM, 
		...
		"Name=salNumber", "Value=1234567890", ENDITEM, 
...
//		
	...
	web_submit_data("OrderSubmitServiceCmd", 
		...
		"Name=ani", "Value=3333333333", ENDITEM, 
		"Name=ACHPRN", "Value=1234567890", ENDITEM, 
	...
	web_url("HPServices_7", 
		"URL=https://{p_hostName}/us-en/shop/HPServices?langId=-1&storeId=10151&catalogId=10051&_=1530682049317&action=cupis&catentryId=&modelId=&retainPOCart=false", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://{p_hostName}/webapp/wcs/stores/servlet/OrderShippingBillingConfirmationView", 
