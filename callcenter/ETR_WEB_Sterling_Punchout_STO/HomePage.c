HomePage()
{
	...
	//lr_start_sub_transaction("CP00-1_Homepage",(lr_eval_string("{AgentType}S00_Homepage")));
	...
	lr_start_sub_transaction("CP00-2_HPServices",(lr_eval_string("{AgentType}S00_Homepage")));
