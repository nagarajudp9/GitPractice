Pay_MasterCard()
{
	...
	lr_start_transaction("CP30_Pay_MC_Review");	
	web_submit_data("PHCReceiver", 
				...
				"\"false\",\"CustomField\":\"{cp_orderNo}-{cp_time}-10151\",\"CreditCards\":[{\"CCNumber\":\"5112345112345114\",\"CardType\":\"002\",\"LastFour\":\"4113\",\"CCToken\":\"\",\"CCSignature\":\"\",\"CCExpYear\":2017,\"CCExpMon\":12,\"CVV\":\"123\",\"CCIssueNo\":\"\",\"CCStartYear\":\"\",\"CCStartMon\":\"\",\"CVVMatchResult\":\"\",\"IsSaveProfile\":false}]}", ENDITEM, 
				LAST);
	...
	{
		lr_end_transaction("CP30_Pay_MC_Review",LR_AUTO);
		ConfirmOrder(1);
	}
	else
	{
		lr_end_transaction("CP30_Pay_MC_Review",LR_FAIL);
		RemoveCart();			
		//CC_Logout();			
