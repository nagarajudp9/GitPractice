CreatePO()
{
	...
	web_submit_data("AjaxOrderShipInfoUpdate", 
		...
		"Name=nickName", "Value=Punchout_STO_CreatePO_{cp_time}", ENDITEM,
	...
	web_submit_data("OrderSubmitServiceCmd", 
		...
		"Name=billto_companyname", "Value=PerfTest", ENDITEM, 
	...
	web_url("HPServices_9", 
		"URL=https://{p_hostName}/us-en/shop/HPServices?langId=-1&storeId=10151&catalogId=10051&_=1527254418422&action=cupis&catentryId=&modelId=&retainPOCart=false", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
