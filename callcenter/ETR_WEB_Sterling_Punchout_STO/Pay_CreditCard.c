			...
			
{
	...
	web_reg_save_param("1234567890","LB=data-ph=\"","RB=\"","Notfound=warning",LAST);
	...
	lr_start_transaction("CP27_Checkout_CC_Saved");
	...
	web_submit_data("AjaxOrderShipInfoUpdate", 
		...
		"Name=phone", "Value=1234567890", ENDITEM, 
...
//	{
//
	lr_end_transaction("CP27_Checkout_CC_Saved",LR_AUTO);
//	//CP27_Checkout_CC_Saved
//	}
//	else
//	{
//		//lr_end_transaction("CP30_Pay_CC_Review",LR_FAIL);
//		lr_end_transaction("CP27_Checkout_CC_Saved",LR_FAIL);
//		
...
//		
	...
	web_submit_data("HPAddressAdd",
		...
		"EncodeAtSign=YES", 
		ITEMDATA, 
		"Name=shipFirstName", "Value=perfTest", ENDITEM, 
		"Name=shipLastName", "Value=perfLast", ENDITEM, 
		"Name=companyinput", "Value=", ENDITEM, 
		"Name=shipAddress1", "Value={p_Address1}", ENDITEM, 
		"Name=shipAddress2", "Value=", ENDITEM, 
		"Name=shipCity", "Value={p_city}", ENDITEM, 
		"Name=shipState", "Value={p_StateNew}", ENDITEM, 
		"Name=shipZipcode", "Value={p_zipCode}", ENDITEM, 
		"Name=shipPhoneno", "Value=1234567890", ENDITEM, 
		"Name=billFirstName", "Value=perfTest", ENDITEM, 
		"Name=billLastName", "Value=perfLast", ENDITEM, 
		"Name=companyinput1", "Value=", ENDITEM, 
		"Name=billAddress1", "Value={p_Address1}", ENDITEM, 
		"Name=billAddress2", "Value=", ENDITEM, 
	...
	web_custom_request("CallPHC", 
		...
		"paymentRequestVM%5BOfferItems%5D%5B0%5D%5BDiscount_Amount%5D=&paymentRequestVM%5BOfferItems%5D%5B0%5D%5BDiscount_Amount_WithTax%5D=&paymentRequestVM%5BOfferItems%5D%5B0%5D%5BUnit%5D=ea&paymentRequestVM%5BOfferItems%5D%5B0%5D%5BItem_Total_Amount%5D=&paymentRequestVM%5BOfferItems%5D%5B0%5D%5BItem_Total_Amount_WithTax%5D=&paymentRequestVM%5BBillAddress%5D%5BAddressName%5D={p_Address1}&paymentRequestVM%5BBillAddress%5D%5BAddress1%5D={p_Address1}&paymentRequestVM%5BBillAddress%5D%5BAddress2%5D=&"
		"paymentRequestVM%5BBillAddress%5D%5BAddress3%5D=&paymentRequestVM%5BBillAddress%5D%5BAddress4%5D=&paymentRequestVM%5BBillAddress%5D%5BCity%5D={p_city}&paymentRequestVM%5BBillAddress%5D%5BCounty%5D=&paymentRequestVM%5BBillAddress%5D%5BState%5D={p_state}&paymentRequestVM%5BBillAddress%5D%5BZip%5D={p_ZipCodeNew}&paymentRequestVM%5BBillAddress%5D%5BCountry%5D=US&paymentRequestVM%5BBillAddress%5D%5BCompanyName%5D=&paymentRequestVM%5BBillAddress%5D%5BContactFirstName%5D=perfTest&"
		"paymentRequestVM%5BBillAddress%5D%5BContactLastName%5D=perfLast&paymentRequestVM%5BBillAddress%5D%5BContactDayPhone%5D=&paymentRequestVM%5BBillAddress%5D%5BContactNightPhone%5D=&paymentRequestVM%5BBillAddress%5D%5BContactEmail%5D=&paymentRequestVM%5BBillAddress%5D%5BFax%5D=&paymentRequestVM%5BCustomerInfo%5D%5BFirstName%5D=perfTest&paymentRequestVM%5BCustomerInfo%5D%5BLastName%5D=perfLast&paymentRequestVM%5BCustomerInfo%5D%5BEmail%5D={cp_EmailAccount}&"
		"paymentRequestVM%5BCustomerInfo%5D%5BPhone%5D=1234567890&paymentRequestVM%5BCustomerInfo%5D%5BHostName%5D=&paymentRequestVM%5BCustomerInfo%5D%5BIPAddress%5D=&paymentRequestVM%5BCustomerInfo%5D%5BHpCustomerNumber%5D=&paymentRequestVM%5BCustomerInfo%5D%5BCompanyName%5D=&paymentRequestVM%5BCustomerInfo%5D%5BIsGuestUser%5D=false&paymentRequestVM%5BReturnKey_Continue%5D="
		"%3FstoreId%3D10151%26amp%3BlangId%3D-1%26amp%3BcalculationUsageId%3D-1%26amp%3BupdatePrices%3D1%26amp%3Bcchost%3Dtrue%26amp%3BorderId%3D.%26amp%3BcrID%3D{cp_correlationId}%26amp%3BQuoteDisable%3DY%26amp%3BrFromPGS%3Dtrue%26amp%3Btld%3D{cp_orderNo}-{cp_time}-10151&paymentRequestVM%5BReturnKey_Cancel%5D="
		"%3FstoreId%3D10151%26amp%3BlangId%3D-1%26amp%3BcatalogId%3D10051%26amp%3BcalculationUsageId%3D-1%26amp%3BupdatePrices%3D1%26amp%3BorderId%3D.%26amp%3Bcancel%3Dtrue%26amp%3Bccl%3D1%26amp%3BcrID%3D{cp_correlationId}%26amp%3BQuoteDisable%3DY&paymentRequestVM%5BContinueURL%5D="
		"https%3A%2F%2F{p_hostName}%2Fwebapp%2Fwcs%2Fstores%2Fservlet%2FPGSCCResponseHandlerView%3FstoreId%3D10151%26amp%3BlangId%3D-1%26amp%3BcalculationUsageId%3D-1%26amp%3BupdatePrices%3D1%26amp%3Bcchost%3Dtrue%26amp%3BorderId%3D.%26amp%3BcrID%3D{cp_correlationId}%26amp%3BQuoteDisable%3DY%26amp%3BrFromPGS%3Dtrue%26amp%3Btld%3D{cp_orderNo}-{cp_time}-10151&paymentRequestVM%5BCancelURL%5D="
	...
	lr_end_transaction("CP30_Pay_CC_Review",LR_PASS);
	}
	else
	{
