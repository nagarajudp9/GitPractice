OpenSearchReturn()
{
	...
	web_reg_save_param("cp_ExtnsnRel","LB=Extn\":{\"ExtnCustomerType\":\"\"},\"EnterpriseCode\":\"USWS\",\"OrderNo\":\"R","RB=\",","ORD=ALL","Notfound=warning",LAST);

	lr_start_transaction("C60_Return_ListOpenSearch");
	...
	web_submit_data("isccs.home.portlets.ReturnsPortletBehaviorController.do",
		...
		"Mode=HTML",
		ITEMDATA,
		"Name=scControllerData", "Value={\"isccs_home_portlets_ReturnsPortletBehaviorController\":{\"controllerId\":\"isccs_home_portlets_ReturnsPortletBehaviorController\",\"MashupRefs\":{\"MashupRef\":[{\"mashupRefId\":\"getReturnOrderList\",\"Input\":{\"Order\":{\"OrderNo\":\"R3010058507\",\"MaximumRecords\":\"2\"}}}]}}}", ENDITEM,
	...
	web_custom_request("wizardController.do",
		...
		"2%3A%22R3010058507%22%2C%22CustomerZipCode%22%3A%22{cp_ZipCode}%22%2C%22Status%22%3A%22" 
	...
	lr_end_transaction("C60_Return_ListOpenSearch",LR_AUTO);
