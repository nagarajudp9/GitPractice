...
web_url("HPServices",
		"URL=https://{p_hostname}/us-en/shop/HPServices?_={cp_time}&action=cupids&catentryId={p_AccesscatentryId_2}&modelId=&langId=-1&storeId=10151&catalogId=10051", 
		"Resource=0", 
...
lr_end_transaction("S00_HpServices_Appstore", LR_AUTO);
	...
	web_url("HPServices",
		"URL=https://{p_hostname}/us-en/shop/HPServices?_={cp_time}&action=cupids&catentryId={p_AccesscatentryId_25}&modelId=&langId=-1&storeId=10151&catalogId=10051", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://{p_hostname}/us-en/shop/slp/", 
		"Snapshot=t111.inf", 
...
else
{
	...
	web_url("HPServices",
		"URL=https://{p_hostname}/us-en/shop/HPServices?_={cp_time}&action=cupids&catentryId={p_AccesscatentryId_50}&modelId=&langId=-1&storeId=10151&catalogId=10051", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://{p_hostname}/us-en/shop/slp/", 
		"Snapshot=t111.inf", 
