...

{
	...
	{
		lr_end_transaction(lr_eval_string("S09_SearchByCTO"),LR_FAIL);
    ...
    {
    	lr_end_transaction(lr_eval_string("{AgentType}S09_SearchByCTO"),LR_PASS);
    }
