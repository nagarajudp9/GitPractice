...
web_reg_save_param("cp_VWAproductId","lb=\"catentryId\":\"","rb=\"","ord=all",LAST);
	...
	web_url("p_ViewAll",
		"URL=https://{p_hostName}/us-en/shop/vwa/{p_ViewAll}{StoreType}",  
		"Resource=0", 
	...
	web_url("HPServices", 
		"URL=https://{p_hostName}/us-en/shop/HPServices?_=1626179256356&action=cu&catentryId=&modelId=&langId=-1&storeId=10151&catalogId=10051",  
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=", 
		"Snapshot=t59.inf", 
	...
	web_url("sync", 
		"URL=https://{p_hostName}/us-en/shop/app/api/web/graphql/page/vwa%2F{p_ViewAll}/sync", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
  ...
  //sprintf(mainfilters, "{main_%d}",randNumber);	
	...
	web_url("HPServices_2", 
		"URL=https://{p_hostName}/us-en/shop/HPServices?_=1626179257621&action=cusipd&catentryId={VWAURL}&modelId=&langId=-1&storeId=10151&catalogId=10051",  
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=", 
		"Snapshot=t63.inf", 
