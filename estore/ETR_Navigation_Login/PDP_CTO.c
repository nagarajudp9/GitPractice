PDP_CTO()
{
	...
	web_url("{cp_pdpURL}", 
		"URL=https://{p_hostName}/us-en/shop/pdp/{cp_pdpURL}{StoreType}", 
		"Resource=0", 
	...
	/*web_url("dealsapi_2", 
		"URL=https://{p_hostName}/us-en/shop/app/api/web/product-group/dealsapi?_=1627102063590", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://{p_hostName}/us-en/shop/pdp/{cp_pdpURL}", 
		"Snapshot=t8.inf", 
...
web_reg_find("Text=\"lowStock\": true", "SaveCount=c_OutOfStock", LAST);
	...
	web_url("HPServices_2", 
		"URL=https://{p_hostName}/us-en/shop/HPServices?_={cp_time}&action=pid&catentryId={cp_CatEntryID},{cp_CatEntryID}&modelId=&langId=-1&storeId=10151&catalogId=10051", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://{p_hostName}/us-en/shop/pdp/{cp_pdpURL}", 
		"Snapshot=t10.inf", 
