CLP()
{
	...
	web_url("p_Landing", 
		"URL=https://{p_hostName}/us-en/shop/cat/{p_Landing}{StoreType}",  
		"Resource=0", 
	...
	web_url("HPServices_2", 
		"URL=https://{p_hostName}/us-en/shop/HPServices?_={cp_time}&action=cusipd&catentryId=&modelId={CLPURL}&langId=-1&storeId=10151&catalogId=10051",  
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://{p_hostName}/us-en/shop/cat/{p_Landing}", 
		"Snapshot=t8.inf", 
