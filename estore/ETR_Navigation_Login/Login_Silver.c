Login_Silver()
{
	...
	lr_start_transaction(lr_eval_string("{AgentType}S02_UserLogin_Silver"));
	...
	if(atoi(lr_eval_string("{Register}"))>0)
        {
			...
			lr_end_transaction(lr_eval_string("{AgentType}S02_UserLogin_Silver"),LR_PASS);
        }
    else
        {
    
    		lr_end_transaction(lr_eval_string("{AgentType}S02_UserLogin_Silver"),LR_FAIL);
