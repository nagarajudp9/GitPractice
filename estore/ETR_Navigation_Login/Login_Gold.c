Login_Gold()
{
	...
	lr_start_transaction(lr_eval_string("{AgentType}S02_UserLogin_Gold"));
	...
	web_url("HPServices_2", 
        ...
        {
			lr_end_transaction(lr_eval_string("{AgentType}S02_UserLogin_Gold"),LR_PASS);
        }
    else
        {
    
    		lr_end_transaction(lr_eval_string("{AgentType}S02_UserLogin_Gold"),LR_FAIL);
