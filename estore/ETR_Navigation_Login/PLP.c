...
lr_start_transaction(lr_eval_string("{AgentType}S11_PLP"));
	...
	web_url("{p_PLP}", 
		"URL=http://{p_hostName}/us-en/shop/plp/{p_PLP}{StoreType}", 
		"TargetFrame=", 
		"Resource=0", 
...
PLPcount1=atoi(lr_eval_string("{cp_PLPcatentryId_count}"));
	...
	web_url("HPServices", 
		"URL=https://{p_hostName}/us-en/shop/HPServices?_=1638773249826&action=cupids&catentryId={PLPURL}&modelId=&langId=-1&storeId=10151&catalogId=10051", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
	...
	web_url("HPServices_2", 
		"URL=https://{p_hostName}/us-en/shop/HPServices?_=1638773252913&action=cusipd&catentryId={PLPURL}&modelId=&langId=-1&storeId=10151&catalogId=10051", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://{p_hostName}/us-en/shop/plp/{p_PLP}", 
