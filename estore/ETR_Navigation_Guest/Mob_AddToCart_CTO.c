Mob_AddToCart_CTO()
{
	...
	if(strcmp(lr_eval_string("{cp_CatEntryID}"),"")==0 )
		...
		lr_end_transaction("S08_MoB_PDP",LR_FAIL);
	...
	web_url("HPServices",
		"URL=https://{p_hostName}/us-en/shop/HPServices?_={cp_time}&action=cupids&catentryId={cp_CatEntryID}&modelId=&langId=-1&storeId=10151&catalogId=10051=",
		"TargetFrame=",
		"Resource=0",
		"RecContentType=text/html",
