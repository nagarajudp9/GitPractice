LoggedInCheckout()
{
	...
	web_url("OrderCalculate_2", 
		"URL=https://{p_hostName}/us-en/shop/OrderCalculate?updatePrices=1&shipmentType=single&calculationUsageId=-1&calculationUsageId=-3&calculationUsageId=-4&errorViewName=AjaxOrderItemDisplayView&catalogId=10051&langId=-1&QuoteDisable=N&URL=OrderShippingBillingView&storeId=10151&orderId=.", 
		"TargetFrame=", 
		"Resource=0", 
...
//		lr_end_sub_transaction("S28-3_LoggedIn_Pay",LR_FAIL);
		...
		lr_end_transaction("S27_Checkout_LoggedIn",LR_FAIL);
...
//		lr_end_sub_transaction("S28-3_LoggedIn_Pay",LR_PASS);
		...
		lr_end_transaction("S27_Checkout_LoggedIn",LR_PASS);
...
//	lr_start_sub_transaction("S28-1_LoggedIn_AjaxOrderShipInfoUpdate","S28_CheckoutDetails_LoggedIn");	
