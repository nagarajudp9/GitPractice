ConvertQuote()
{
	...
	web_set_max_html_param_len("999024");
...
*/
	web_url("HPServices_8", 
		"URL=https://{p_hostName}/us-en/shop/HPServices?langId=-1&storeId=10151&catalogId=10051&_=1598091062018&action=cupids&catentryId=&modelId=&retainPOCart=false", 
		"Resource=0", 
		"RecContentType=text/html", 
...
web_submit_data("ValidateConfigurationCmd_2", 
		"Action=https://{p_hostName}/us-en/shop/ValidateConfigurationCmd", 
		"Method=POST", 
		"RecContentType=text/html", 
		"Referer=https://{p_hostName}/us-en/shop/OrderShippingBillingView?pStoreID=fedex&storeId=10151&catalogId=10051&langId=-1&krypto={cp_krypto}&ddkey=https%3AQuoteGenerateOrder", 
		"Snapshot=t18.inf", 
		"Mode=HTML", 
		ITEMDATA, 
...
web_reg_save_param_ex("ParamName=cp_PaymentRequest","LB=JWT&quot;:&quot;","RB=&quot;","Notfound=warning",LAST);
	...
	//lr_start_sub_transaction("S28-3_LoggedIn_Pay","S62_ConvertQuoteToOrder");
	...
	web_reg_save_param_ex("ParamName=cp_addressId","LB=\"addressId\": \"","RB=\"","Notfound=Warning",LAST);
