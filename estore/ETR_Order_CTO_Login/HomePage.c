HomePage()
{
	...
	web_url("HPServices_2", 
		"URL=https://{p_hostName}/us-en/shop/HPServices?_=1624368711398&action=ipd&catentryId={HomeURL}&modelId=&langId=-1&storeId=10151&catalogId=10051", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://{p_hostName}/us-en/shop", 
