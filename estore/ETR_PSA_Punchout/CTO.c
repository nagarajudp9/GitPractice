CTO()
{
	...
	lr_start_transaction("CP09_PDP_CTO");
	...
	web_url("SearchDisplay", 
		...
		//"URL=https://{p_hostName}/us-en/shop/SearchDisplay?client=&charset=utf-8&searchTerm={p_PartNumber}&storeId=10151&catalogId=10051&langId=-1&be",
		"Resource=0",
...
web_reg_find("Text=\"lowStock\": true", "SaveCount=c_OutOfStock", LAST);
    ...
    {
	lr_end_transaction("CP09_PDP_CTO",LR_PASS);
    }
    else
    {
	lr_end_transaction("CP09_PDP_CTO",LR_FAIL);
