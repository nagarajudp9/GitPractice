...
int SignInFormFlag=0, GuestFlag=0, LoginFlag=0, hpeppFlag=0, eppFlag=0, gsFlag=0, ctoFlag=0, gs_ccFlag=0, CustomerFlag=0, psaFlag=0,mFound=0;
int i,j,k;
int CarepackFlag=0,Stoflag=0,nFound=0;
